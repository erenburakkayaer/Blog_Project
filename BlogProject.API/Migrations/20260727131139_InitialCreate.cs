    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "Slug", "Type" },
                values: new object[,]
                {
                    { 1, "Teknoloji", "teknoloji", "Blog" },
                    { 2, "Web Yazılımı", "web-yazilimi", "Service" },
                    { 3, "Mobil Uygulama", "mobil-uygulama", "Project" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "IsActive", "LastLoginAt", "PasswordHash", "RoleId", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@firmaadi.com", true, null, "iB4Yvj4TzjKnFpjWpQo/yA==.oFW+NPnjtdHiCBkKYNIdD50boXqgya9uL1q8J5W/04A=", 1, "admin" });
